...
/** The type of memory resource used by the library.
    ...
    for `snps_boost_1_77_0::container::pmr::memory_resource`.
...
/** The type of polymorphic allocator used by the library.
    ...
    for `snps_boost_1_77_0::container::pmr::polymorphic_allocator`.
    Compiling a program using the library will
    require Boost, and a compiler conforming
    to C++11 or later.
...
#else
using memory_resource = snps_boost_1_77_0::container::pmr::memory_resource;

template<class T>
using polymorphic_allocator =
    snps_boost_1_77_0::container::pmr::polymorphic_allocator<T>;
#endif
...
/** Return true if a memory resource's deallocate function has no effect.
    ...
    namespace snps_boost_1_77_0 {} namespace boost = snps_boost_1_77_0; namespace snps_boost_1_77_0 {
    namespace json {
