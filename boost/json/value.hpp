...
*/
template<>
struct tuple_size< ::snps_boost_1_77_0::json::key_value_pair >
...
*/
template<>
struct tuple_element<0, ::snps_boost_1_77_0::json::key_value_pair>
{
    using type = ::snps_boost_1_77_0::json::string_view const;
};

/** Tuple-like access for the value type of key_value_pair
*/
template<>
struct tuple_element<1, ::snps_boost_1_77_0::json::key_value_pair>
{
    using type = ::snps_boost_1_77_0::json::value&;
};

/** Tuple-like access for the value type of key_value_pair
*/
template<>
struct tuple_element<1, ::snps_boost_1_77_0::json::key_value_pair const>
{
    using type = ::snps_boost_1_77_0::json::value const&;
};
...
namespace std {
template <>
struct hash< ::snps_boost_1_77_0::json::value > {
    BOOST_JSON_DECL
    std::size_t
    operator()(::snps_boost_1_77_0::json::value const& jv) const noexcept;
};
} // std
#endif
