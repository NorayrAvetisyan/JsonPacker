...
std::size_t
std::hash<::snps_boost_1_77_0::json::array>::operator()(
    ::snps_boost_1_77_0::json::array const& ja) const noexcept
{
  std::size_t seed = ja.size();
  for (const auto& jv : ja) {
    seed = ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        std::hash<::snps_boost_1_77_0::json::value>{}(jv));
  }
  return seed;
}
