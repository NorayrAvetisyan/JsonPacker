...
std::size_t
std::hash<::snps_boost_1_77_0::json::value>::operator()(
    ::snps_boost_1_77_0::json::value const& jv) const noexcept
{
  std::size_t seed = static_cast<std::size_t>(jv.kind());
  switch (jv.kind()) {
    default:
    case ::snps_boost_1_77_0::json::kind::null:
      return seed;
    case ::snps_boost_1_77_0::json::kind::bool_:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        hash<bool>{}(jv.get_bool()));
    case ::snps_boost_1_77_0::json::kind::int64:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        static_cast<size_t>(::snps_boost_1_77_0::json::kind::uint64),
        hash<std::uint64_t>{}(jv.get_int64()));
    case ::snps_boost_1_77_0::json::kind::uint64:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        hash<std::uint64_t>{}(jv.get_uint64()));
    case ::snps_boost_1_77_0::json::kind::double_:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        hash<double>{}(jv.get_double()));
    case ::snps_boost_1_77_0::json::kind::string:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        hash<::snps_boost_1_77_0::json::string>{}(jv.get_string()));
    case ::snps_boost_1_77_0::json::kind::array:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        hash<::snps_boost_1_77_0::json::array>{}(jv.get_array()));
    case ::snps_boost_1_77_0::json::kind::object:
      return ::snps_boost_1_77_0::json::detail::hash_combine(
        seed,
        hash<::snps_boost_1_77_0::json::object>{}(jv.get_object()));
  }
}
