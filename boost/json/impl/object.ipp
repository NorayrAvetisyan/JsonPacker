...
std::size_t
std::hash<::snps_boost_1_77_0::json::object>::operator()(
    ::snps_boost_1_77_0::json::object const& jo) const noexcept
{
    std::size_t seed = jo.size();
    for (const auto& kv_pair : jo) {
        auto const hk = ::snps_boost_1_77_0::json::detail::digest(
            kv_pair.key().data(), kv_pair.key().size(), 0);
        auto const hkv = ::snps_boost_1_77_0::json::detail::hash_combine(
            hk,
            std::hash<::snps_boost_1_77_0::json::value>{}(kv_pair.value()));
        seed = ::snps_boost_1_77_0::json::detail::hash_combine_commutative(seed, hkv);
    }
    return seed;
}
