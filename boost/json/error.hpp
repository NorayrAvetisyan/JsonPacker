...
/** The type of error code used by the library.
    ...
    for `snps_boost_1_77_0::system::error_code`.
...
/** The type of error category used by the library.
    ...
    If the macro `BOOST_JSON_STANDALONE` is
    not defined, this type will be an alias
    for `snps_boost_1_77_0::system::error_category`.
    Compiling a program using the library will
    require Boost, and a compiler conforming
    to C++11 or later.
...
/** The type of error condition used by the library.
    ...
    If the macro `BOOST_JSON_STANDALONE` is
    not defined, this type will be an alias
    for `snps_boost_1_77_0::system::error_condition`.
    Compiling a program using the library will
    require Boost, and a compiler conforming
    to C++11 or later.
...
/** The type of system error thrown by the library.
    ...
    If the macro `BOOST_JSON_STANDALONE` is
    not defined, this type will be an alias
    for `snps_boost_1_77_0::system::system_error`.
    Compiling a program using the library will
    require Boost, and a compiler conforming
    to C++11 or later.
...
using error_code = snps_boost_1_77_0::system::error_code;
using error_category = snps_boost_1_77_0::system::error_category;
using error_condition = snps_boost_1_77_0::system::error_condition;
using system_error = snps_boost_1_77_0::system::system_error;
using snps_boost_1_77_0::system::generic_category;
